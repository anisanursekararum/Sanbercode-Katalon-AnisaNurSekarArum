...
WebUI.verifyMatch(price, ('.*' + nexusPrice) + '.*', true)

WebUI.verifyElementText(findTestObject('Product/titleProductDesc'), productDesc)

WebUI.verifyElementText(findTestObject('Product/productDesc'), nexusProdDesc)
